...
#include "admSecondarySubstrateRateInhibition.H"
...
namespace Foam
{
    defineTypeNameAndDebug(admSecondarySubstrateRateInhibition, 0);
...
admJumpTableDerivative(coeff_KI_, admSecondarySubstrateRateInhibition)
{
    scalar denomRoot
    (
...
admJumpTableFieldDerivative(coeff_KI_, admSecondarySubstrateRateInhibition)
{
...
admJumpTableDerivative(var_SI_, admSecondarySubstrateRateInhibition)
{
...
admJumpTableFieldDerivative(var_SI_, admSecondarySubstrateRateInhibition)
{
...
Foam::scalar Foam::admSecondarySubstrateRateInhibition::ddyFns_0
(
...
Foam::tmp<scalarField> Foam::admSecondarySubstrateRateInhibition::ddyFieldFns_0
(
    const admVariable& wrtVar
) const
{
...
Foam::scalar Foam::admSecondarySubstrateRateInhibition::inhibition
(
    label cellIndex
) const
{
...
Foam::tmp<scalarField>
    Foam::admSecondarySubstrateRateInhibition::inhibitionField() const
{
    return tmp<scalarField>
    (
        new scalarField
...
bool Foam::admSecondarySubstrateRateInhibition::inhibitionNonZero() const
{
    return true;
}


Foam::scalar Foam::admSecondarySubstrateRateInhibition::ddy
(
    const admVariable& wrtVar,
    label cellIndex
) const
...
Foam::tmp<scalarField> Foam::admSecondarySubstrateRateInhibition::ddyField
(
    const admVariable& wrtVar
) const
{
...
bool Foam::admSecondarySubstrateRateInhibition::ddyNonZero
(
    const admVariable& wrtVar
) const
{
